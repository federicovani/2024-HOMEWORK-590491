...
public class LabirintoBuilderTest {
	private it.uniroma3.diadia.ambienti.Labirinto.LabirintoBuilder labirintoBuilder;
...
//	}
	...
	public void testLabirintoCompletoConTutteLeStanze() {
		...
		assertTrue(corridoio.getDirezioni().containsAll(Arrays.asList(Direzione.NORD, Direzione.SUD, Direzione.EST, Direzione.OVEST)));
